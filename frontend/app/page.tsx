        ...
        <main className="start-screen">
          ...
          <section id="features" className="landing-section landing-first pt-2">
            ...
            <div className="section-content">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border-2 border-white/30 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.2)] hover:shadow-[0_20px_60px_-15px_rgba(255,255,255,0.15)] transition-shadow duration-300">

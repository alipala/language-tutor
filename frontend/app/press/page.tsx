    ...
    <div className="min-h-screen" style={{ backgroundColor: '#0A0A0F' }}>
      ...
      <div className="bg-gradient-to-r from-brand/20 to-[#3a9e92]/20 border-b border-white/[0.08] py-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            <h1 className="text-5xl font-bold text-white mb-6">MyTaco AI Press Kit</h1>
      ...
      <div className="py-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h3 className="text-2xl font-bold text-white mb-6">About MyTaco AI</h3>
            ...
            >
              <h4 className="text-xl font-bold text-white mb-6">Key Facts</h4>
              ...
              <div className="mt-8 pt-6 border-t border-white/[0.08]">
                <h5 className="font-bold text-white mb-3">Mission</h5>
      ...
      {/* Press Assets */}
      <div className="py-20" style={{ backgroundColor: '#0E0E1A' }}>
        <div className="max-w-6xl mx-auto px-6">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl font-bold text-white mb-6">Press Assets</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {assets.map((asset, index) => (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-white/40 text-sm">{asset.size}</p>
                    </div>
                  </div>
                  <button
                ...
                <p className="text-white/60 leading-relaxed">{asset.description}</p>
              </motion.div>
            ))}
          </div>
      ...
      <div className="py-20">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl font-bold text-white mb-6">Upcoming Milestones</h2>
            <p className="text-xl text-white/60 max-w-3xl mx-auto">
      ...
      <div className="py-20 border-t border-white/[0.08]" style={{ backgroundColor: '#0E0E1A' }}>
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="rounded-2xl p-8 border border-white/[0.10] max-w-md mx-auto" style={{ backgroundColor: '#13131F' }}>
            ...
            <div className="mt-8 grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
              <div className="rounded-xl p-6 border border-white/[0.10]" style={{ backgroundColor: '#13131F' }}>
                <h4 className="font-bold text-white mb-2">Gamze Dede Pala</h4>
                <p className="text-sm text-white/60 mb-2">Co-Founder</p>
                <p className="text-xs text-white/40">
                  Expert in Prompt Engineering, Context Engineering, and accessible learning solutions
                </p>
              </div>
              <div className="rounded-xl p-6 border border-white/[0.10]" style={{ backgroundColor: '#13131F' }}>
                <h4 className="font-bold text-white mb-2">Ali Pala</h4>
                <p className="text-sm text-white/60 mb-2">Co-Founder</p>
                <p className="text-xs text-white/40">

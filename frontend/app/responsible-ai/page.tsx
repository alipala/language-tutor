    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">What We Think</h2>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Our AI Principles</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-[#4ECFBF]/10 to-[#4ECFBF]/5 rounded-2xl p-8 border border-[#4ECFBF]/20 hover:border-[#4ECFBF]/40 transition-all duration-300 hover:shadow-lg">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-4">Fairness & Bias Mitigation</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-[#FFD63A]/10 to-[#FFD63A]/5 rounded-2xl p-8 border border-[#FFD63A]/20 hover:border-[#FFD63A]/40 transition-all duration-300 hover:shadow-lg">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-4">Transparency & Explainability</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-[#FFA955]/10 to-[#FFA955]/5 rounded-2xl p-8 border border-[#FFA955]/20 hover:border-[#FFA955]/40 transition-all duration-300 hover:shadow-lg">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-4">Accountability & Governance</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-[#4ECFBF]/10 to-[#F75A5A]/5 rounded-2xl p-8 border border-[#4ECFBF]/20 hover:border-[#F75A5A]/20 transition-all duration-300 hover:shadow-lg">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-4">Reliability & Safety</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-[#FFD63A]/10 to-[#FFA955]/5 rounded-2xl p-8 border border-[#FFD63A]/20 hover:border-[#FFA955]/20 transition-all duration-300 hover:shadow-lg">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-4">Inclusiveness & Accessibility</h3>
              <p className="text-gray-600 leading-relaxed">
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-slate-50 to-slate-100">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Our Approach to Responsible AI</h2>
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-bold text-gray-800 mb-4">Ethics by Design</h3>
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-4">Continuous Monitoring</h3>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-800 mb-4">Human-Centered AI</h3>
                <p className="text-gray-600 leading-relaxed mb-6">
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Implementation in Practice</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center bg-gradient-to-br from-[#4ECFBF]/5 to-[#4ECFBF]/10 rounded-2xl p-6 border border-[#4ECFBF]/20">
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-2">Personalized Learning</h3>
            ...
            <div className="text-center bg-gradient-to-br from-[#FFD63A]/5 to-[#FFD63A]/10 rounded-2xl p-6 border border-[#FFD63A]/20">
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-2">Bias-Free Assessment</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center bg-gradient-to-br from-[#F75A5A]/5 to-[#F75A5A]/10 rounded-2xl p-6 border border-[#F75A5A]/20">
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-2">Transparent Feedback</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center bg-gradient-to-br from-[#FFA955]/5 to-[#FFA955]/10 rounded-2xl p-6 border border-[#FFA955]/20">
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-2">Privacy-First Design</h3>
              <p className="text-gray-600 text-sm">
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-slate-50 to-slate-100">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Our Ongoing Commitments</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-800">Learner-Centric AI</h3>
              </div>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-800">Continuous Improvement</h3>
              </div>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-800">Open Dialogue</h3>
              </div>
              <p className="text-gray-600 leading-relaxed">
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-gray-800 mb-8">Join the Conversation</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-2">Community Feedback</h3>
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-2">Research Collaboration</h3>
              <p className="text-gray-600 text-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-2">Ethics Consultation</h3>
              <p className="text-gray-600 text-center">
